...
# kczulko: setting to true since this doesn't exist in 22.11  
...
let
  ...
  is7  = majorVersion == "7";
    ...
    extraTargetFlags = (callFile ./common/extra-target-flags.nix { });
in
...
pipe ((callFile ./common/builder.nix {}) ({
  ...
  hardeningDisable = [
    "format"
    "pie"
    # kczulko: this flag doesn't exist in 22.11
  ...
  # kczulko: this got explicitly replaced
  ...
  NIX_LDFLAGS = toString (optionalString hostPlatform.isSunOS "-lm");

      # EXTRA_FLAGS_FOR_TARGET
      # EXTRA_LDFLAGS_FOR_TARGET;
  EXTRA_FLAGS_FOR_TARGET = toString extraTargetFlags.EXTRA_FLAGS_FOR_TARGET;
  EXTRA_LDFLAGS_FOR_TARGET = toString extraTargetFlags.EXTRA_LDFLAGS_FOR_TARGET;
